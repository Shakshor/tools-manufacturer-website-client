...
const NewsLetter = () => {
    return (
        <div className="hero min-h-full lg:h-96  bg-base-200 my-5">
            <div className="hero-content text-center">
                <div className="max-w-md">
                    ...
                    <input type="text" placeholder="Enter e-mail here" className="input input-bordered input-primary w-full max-w-xs text-base" />
                    <br></br>
