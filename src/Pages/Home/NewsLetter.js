...
const NewsLetter = () => {
    return (
        <section>
            <div className="hero min-h-full lg:h-96 bg-green-100 my-5">
                <div className="hero-content text-center">
                    <div className="max-w-md">
                        <h1 className="text-4xl font-bold text-">Newsletter</h1>
                        <p className="py-6 text-lg">Subscribe to our newsletters now and stay up to date with new collections and exclusive offers</p>
